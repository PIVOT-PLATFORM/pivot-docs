...
| [ADR-007](ADR-007-design-system-angular-cdk.md) | Design system : Angular CDK + SCSS BEM custom | Accepté |
| [ADR-008](ADR-008-cadre-integration-open-source.md) | Cadre d'intégration open source « mycélium » (proposition) | Proposé |
