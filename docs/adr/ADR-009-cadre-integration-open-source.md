...
| ADR-019 | Modèle d'entités du catalogue, réconcilié avec le schéma `public.teams` (ADR-006) | P0 |
| ADR-020 | Stratégie Git des forks (submodule vs subtree vs package) | P1 |
| ADR-021 | Bus d'événements et schéma d'événements inter-briques | P1 |
| ADR-022 | Briques natives à construire (planning poker, CLM) et périmètre | P2 |

*(ADR-010 : attribuée entre-temps à un sujet indépendant, roadmap/Gantt — sans lien avec cette section ; le choix du fournisseur d'identité reste couvert par ADR-004. ADR-011 à ADR-016 : famille Sécurité & Zero Trust, cf. `docs/adr/README.md`. ADR-017 : tiers de sensibilité cyber & durcissement gradué des modules — réservation décalée de 017–020 à 018–021, cf. Historique v1.3. ADR-018 : segmentation physique de l'infrastructure par zone & palier — réservation décalée une seconde fois, de 018–021 à 019–022, cf. Historique v1.4.)*
...
| v1.3 | 2026-07-08 | ADR-017 attribuée à un sujet indépendant (tiers de sensibilité cyber, cf. `docs/adr/ADR-017-tiers-sensibilite-durcissement-modules.md`) — réservation « ADR à produire » décalée de 017–020 à 018–021, même principe que le décalage déjà documenté pour ADR-010 |
| v1.4 | 2026-07-08 | ADR-018 attribuée à un sujet indépendant (segmentation infrastructure multi-zone, cf. `docs/adr/ADR-018-segmentation-infrastructure-multi-zone.md`) — réservation « ADR à produire » décalée une seconde fois, de 018–021 à 019–022 |
