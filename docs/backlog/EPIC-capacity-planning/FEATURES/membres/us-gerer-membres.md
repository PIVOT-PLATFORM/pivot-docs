...
| Critère | 🤖 Dev |
|---------|--------|
| Membres de l'événement issus de l'équipe (FK `public.teams.id`) | ⬜ |
| Possibilité d'exclure certains membres d'un événement (ex. en congé) | ⬜ |
| Taux de disponibilité par membre configurable (50% / 75% / 100%) | ⬜ |
| Test TI : membres d'un autre tenant inaccessibles | ⬜ |
