# EN23.11 — ADR-012 : stratégie de forks

**Type d'enabler** : gouvernance · git

**Contexte** : Définir la règle submodule vs subtree vs package et le cycle de vie des forks contributifs (ADR-008 §6) : branche miroir, resynchronisation hebdomadaire, `FORK.md`, condition de mort.
