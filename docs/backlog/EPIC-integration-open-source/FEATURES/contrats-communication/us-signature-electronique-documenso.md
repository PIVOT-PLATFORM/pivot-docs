# US23.5.1 — Signature électronique (Documenso)
...
| Critère | 🤖 Dev |
|---------|--------|
| Adaptateur `adapter-documenso` conforme au contrat PivotAdapter (EN23.3) | ⬜ |
| Un document signé via Documenso émet `contract.signed` sur le bus | ⬜ |

---
Item Type: US · Parent: F23.5 · Module: contrats · Phase: phase-3 · Size: M · Priority: High
Stage: Backlog
Dépendances: EN23.3, EN23.4
