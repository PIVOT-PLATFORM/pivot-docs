...
## Statut global
🔄 Sprint 2 en cours — EN03.1-3 + US03.x en Review · EN03.4 backlog
...
|---------|--------|
| **Enablers** | |
| [EN03.1 — PivotModule interface + registre backend](ENABLERS/en-module-registry-backend.md) | 🔎 Review |
| [EN03.2 — Guard Angular moduleGuard + status API](ENABLERS/en-module-guard-angular.md) | 🔎 Review |
| [EN03.3 — Cache Redis statut modules TTL 60s](ENABLERS/en-module-cache-redis.md) | 🔎 Review |
...
| [US03.1.1 — Admin active un module pour son tenant](FEATURES/activation-admin/us-admin-active-module.md) | 🔎 Review |
| [US03.1.2 — Admin désactive un module pour son tenant](FEATURES/activation-admin/us-admin-desactive-module.md) | 🔎 Review |
| **F03.2 — Interface admin Angular** | |
| [US03.2.1 — UI liste modules disponibles avec statut](FEATURES/interface-admin-angular/us-liste-modules.md) | 🔎 Review |
| [US03.2.2 — Guard Angular bloque accès module désactivé](FEATURES/interface-admin-angular/us-guard-module-desactive.md) | 🔎 Review |
