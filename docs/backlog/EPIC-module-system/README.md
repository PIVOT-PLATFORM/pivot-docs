...
F03.3 (SUPER_ADMIN, SaaS) reste `phase-3`, non démarré
...
| [US03.3.1 — SUPER_ADMIN définit modules disponibles par plan](FEATURES/activation-super-admin/us-super-admin-modules-plan.md) | ✅ Done |
| [US03.3.2 — SUPER_ADMIN active/désactive un module par tenant (override)](FEATURES/activation-super-admin/us-super-admin-override.md) | ✅ Done |
| [US03.3.3 — Admin tenant voit uniquement modules de son plan](FEATURES/activation-super-admin/us-admin-voit-modules-plan.md) | ✅ Done |
