# Sprint 23 — E18 Pilotage — Habillage entreprise (Cloud, RGPD, RGAA, on-premise)
...
>
> **Phase** : phase-3 · E18. **Sortie** : les enablers d'habillage entreprise : Cloud/SaaS RGPD, localisation FR & RGAA, performance de consolidation, administration sans code, hébergement France/UE, option on-premise.
>
> **Dépendances** : Anciennement en queue idéation (re-tri 2026-07-10) — **réintégrés** pour couvrir 100 % du domaine Pilotage. Dépend du cœur Pilotage (S14-S22).
>
...
|------|-------|------|----------|--------|
| EN18.3 | Cloud/SaaS et RGPD | L | Critical | ⬜ |
| EN18.4 | Localisation FR et RGAA | L | Critical | ⬜ |
| EN18.5 | Performance de consolidation | L | High | ⬜ |
| EN18.6 | Administration sans code | L | High | ⬜ |
| EN18.7 | Hébergement France/UE | M | High | ⬜ |
| EN18.8 | Option on-premise | XL | Medium | ⬜ |
