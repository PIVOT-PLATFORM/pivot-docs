...
| [Sprint 14](./sprint-14.md) | Parité whiteboard — Canvas UX & présence (F08.11/F08.5) | 🟡 6/9 items code-complets — **manquent** US08.11.1 (aimantation grille), US08.11.4 (guides d'alignement), US08.11.2 partiel (boutons zoom/ajuster) — réconcilié 2026-07-20, voir sprint-14.md |
...
| [Sprint 16](./sprint-16.md) | Parité whiteboard — Cycle de vie & partage (F08.13/US08.2.5) | 🟡 4/6 items code-complets — ⚠️ **US08.2.5 (inviter par email) régression de bascule modulith** (codé et mergé pré-migration, absent du monolith actuel) ; US08.13.2 (brouillon de template) non commencé — réconcilié 2026-07-20, voir sprint-16.md |
