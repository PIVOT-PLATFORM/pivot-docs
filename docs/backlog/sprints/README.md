...
| [Sprint 19](./sprint-19.md) | Agilité — Rétrospective + PI Planning | 🔎 les deux lots code-complets — E20 Rétrospective 7/7 US (backend+frontend, aucun gap AC) + E50 PI Planning 3/3 US retenues (core#259+ui#264) — recette ; EN20.3/US50.2.1/EN50.1 bloqués, voir sprint-19.md |
