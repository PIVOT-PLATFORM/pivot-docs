...
| US09.2.1 | Voter sur un ticket en temps réel | M | High | 🟡 Gate 1 AC 100/100 ([pivot-docs#198](https://github.com/PIVOT-PLATFORM/pivot-docs/pull/198), non fusionnée — pas bloquant) · backend PR ouverte ([pivot-agilite-core#42](https://github.com/PIVOT-PLATFORM/pivot-agilite-core/pull/42), 418 tests, Checkstyle/SpotBugs/coverage verts localement) · frontend PR ouverte ([pivot-agilite-ui#37](https://github.com/PIVOT-PLATFORM/pivot-agilite-ui/pull/37), 269 tests, coverage 93%+) — autoloop CI en cours des deux côtés |
