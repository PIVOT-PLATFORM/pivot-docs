...
> E23 vague 2) ont été **remontés en Sprint 20 (ex-satellites Pilotage — extrait)** — voir aussi la §Queue idéation
...
- E23 vague 2 : ~~US23.2.3 revues/comités, US23.2.5 programmes, US23.2.6 plans stratégiques~~ **→ Sprint 20 (ex-satellites Pilotage — extrait)** · restent ici : US23.2.7/23.2.8 what-if & business cases (ex-E31), US23.2.9/23.2.10 livrables & valeur publique (idéation)
- ~~E24 ADR projet · E26 Budget · E27 OKR~~ **→ Sprint 20 (ex-satellites Pilotage — extrait)** (satellites Pilotage à valeur, remontés au re-tri 2026-07-10) · E27 F27.4-10 (check-ins, scoring, gouvernance) + E26 F26.2 vague 2 restent post-S20 · **E25 Commande publique** reste en idéation (`BACKLOG-IDEATION`)
...
> `BACKLOG-IDEATION` — voir aussi Sprint 9 (socle technique Pilotage — extrait, voir `PILOTAGE-HANDOFF.md`).
