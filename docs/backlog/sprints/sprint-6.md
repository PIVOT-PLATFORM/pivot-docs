...
> **Pré-requis du jalon :** rédiger la **Definition of Done Socle** (checklist explicite features/prod/recette) — voir [§Zones d'ombre n°1](./zones-ombre.md). Sans elle, le verrou §6 du modèle backlog reste une déclaration sans critère.
