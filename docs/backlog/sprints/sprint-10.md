...
| US22.4.8 | Suivi d'avancement (% réalisé, réel/restant) | L | High | ⬜ backend mergé ([pivot-pilotage-core#59](https://github.com/PIVOT-PLATFORM/pivot-pilotage-core/pull/59)) — frontend `pivot-pilotage-ui` restant |
