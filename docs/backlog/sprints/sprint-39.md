# Sprint 39 — Parité whiteboard — Objets typés & connecteurs
...
**Jalon d'entrée :** dépend du modèle `Card` typé (EN08.4, Sprint 38) — les objets typés de ce
...
- **Bloque :** Sprint 41 (objets à manipuler pour le canvas UX & présence) et Sprint 43 (l'import
