...
| EN17.1 | Publication `pivot-core-starter` (Maven, extraction depuis `pivot-core`) | L | Critical | 🔄 Partiel — PR #167 (structure multi-module + `fr.pivot.core.db`) et PR #173 (`fr.pivot.core.modules` + `fr.pivot.core.tenant.TenantContext`, closes #172) mergées ; `auth`/`team` restent à extraire, voir [`pivot-core#171`](https://github.com/PIVOT-PLATFORM/pivot-core/issues/171) |
