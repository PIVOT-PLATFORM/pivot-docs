# Sprint 11 — Parité whiteboard — Fondation modèle Card
...
visible du Sprint 10 : elle rapatrie l'intégralité du spec de réimplémentation fine du POC
...
Le Sprint 11 en est la **fondation bloquante** : l'enabler **EN08.4** introduit le modèle `Card`
...
- Sprint mono-item volontairement isolé : la fondation modèle doit être stabilisée et mergée avant
  d'ouvrir les branches des objets typés en parallèle (Sprint 12+).
