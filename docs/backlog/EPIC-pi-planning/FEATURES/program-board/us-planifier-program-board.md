...
| Critère | 🤖 Dev |
|---------|--------|
| Matrice équipes du Train (lignes) × itérations du PI (colonnes), avec ligne Train dédiée et colonne "Non planifié" | ⬜ |
| Ticket typé : Feature, Milestone, Risque, Objectif, Story, Enabler | ⬜ |
| Placement d'un ticket par glisser-déposer sur la matrice | ⬜ |
