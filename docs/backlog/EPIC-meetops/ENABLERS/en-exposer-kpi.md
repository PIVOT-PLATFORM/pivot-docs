...
- Ces deux écarts, plus le 3ᵉ déclencheur d'AC-EN12.3-04 qu'il n'est pas possible de raccorder aujourd'hui ("action de réunion clôturée" — même raison, aucune mutation à laquelle accrocher l'event), sont proposés à validation Gate 3/4 humaine plutôt qu'auto-certifiés.
