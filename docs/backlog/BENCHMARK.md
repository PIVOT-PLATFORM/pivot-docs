...
- **[E40 — Profil & adaptation](pathname:///pivot-docs/backlog/EPIC-profil-adaptation/)** (nouveau, `PP-A01…A06`) : le profil (TPE / PME / Grand groupe / Privée sous droit public / Publique / État) pilote l'activation des modules, la **classe de souveraineté (A/B/C)** et le niveau de rigueur.
...
(F29.1–14) + 6 enablers NFR (EN29.1–6). Détail : [`EPIC-workflows/README.md`](pathname:///pivot-docs/backlog/EPIC-workflows/).
