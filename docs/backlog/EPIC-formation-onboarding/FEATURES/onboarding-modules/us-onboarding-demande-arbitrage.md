...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Demande & arbitrage** ([E31](../../../EPIC-demande-arbitrage/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
