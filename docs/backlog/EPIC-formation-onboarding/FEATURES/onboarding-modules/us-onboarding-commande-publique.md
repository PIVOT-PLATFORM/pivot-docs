...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Commande publique** ([E25](../../../EPIC-commande-publique/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
