...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Gouvernance & sécurité (pilotage)** ([E35](../../../EPIC-pilotage-gouvernance/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
