...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Cahiers de Tests** ([E13](../../../EPIC-cahiers-tests/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
