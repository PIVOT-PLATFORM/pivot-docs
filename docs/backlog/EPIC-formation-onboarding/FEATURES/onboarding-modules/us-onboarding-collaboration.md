# US41.5.19 — Onboarding in-app — Collaboration (E30)

**En tant que** nouvel utilisateur du module
**Je veux** un **parcours d'onboarding in-app propre au module Collaboration** (tour guidé, points clés, checklist, empty states), branché sur le framework EN41.1
**Afin de** comprendre et adopter Collaboration directement dans l'outil
