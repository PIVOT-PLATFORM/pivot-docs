...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Rétrospective** ([E20](../../../EPIC-retrospective/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
