...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Gestion des risques** ([E21](../../../EPIC-risk/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
