...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Gestion des risques** ([E21](pathname:///pivot-docs/backlog/EPIC-risk/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
