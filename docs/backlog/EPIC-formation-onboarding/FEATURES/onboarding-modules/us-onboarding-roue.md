...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **La Roue** ([E14](../../../EPIC-roue/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés — créer une roue, tirage pondéré anti-repeat, diffusion temps réel du résultat (via EN41.1) | ⬜ |
