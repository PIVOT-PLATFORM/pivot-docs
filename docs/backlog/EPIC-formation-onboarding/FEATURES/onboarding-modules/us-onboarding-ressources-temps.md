...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Ressources & temps** ([E32](pathname:///pivot-docs/backlog/EPIC-ressources-temps/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
