...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Session live** ([E19](../../../EPIC-module-session/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
