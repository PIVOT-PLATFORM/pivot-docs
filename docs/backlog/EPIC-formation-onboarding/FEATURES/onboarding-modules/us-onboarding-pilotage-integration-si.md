...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Intégration SI (pilotage)** ([E36](../../../EPIC-pilotage-integration-si/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
