...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Intégration SI (pilotage)** ([E36](pathname:///pivot-docs/backlog/EPIC-pilotage-integration-si/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
