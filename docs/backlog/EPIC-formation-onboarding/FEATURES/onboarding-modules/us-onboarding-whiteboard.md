...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Whiteboard** ([E08](../../../EPIC-whiteboard/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés — canevas temps réel, partage par lien/rôles, templates (via EN41.1) | ⬜ |
