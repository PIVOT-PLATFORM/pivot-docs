...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Capacity Planning** ([E11](../../../EPIC-capacity-planning/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
