...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Profil & adaptation** ([E40](../../../EPIC-profil-adaptation/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
