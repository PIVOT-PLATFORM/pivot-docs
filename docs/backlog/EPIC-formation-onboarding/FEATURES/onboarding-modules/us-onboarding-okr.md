...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **OKR** ([E27](pathname:///pivot-docs/backlog/EPIC-okr/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
