...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Portefeuille projets** ([E23](pathname:///pivot-docs/backlog/EPIC-portefeuille/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
