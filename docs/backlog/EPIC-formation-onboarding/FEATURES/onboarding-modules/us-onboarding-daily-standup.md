...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Daily Standup** ([E10](../../../EPIC-daily-standup/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés — créer une session, minuteur configurable, rotation des participants (via EN41.1) | ⬜ |
