...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **IA & agents (pilotage)** ([E34](pathname:///pivot-docs/backlog/EPIC-pilotage-ia/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
