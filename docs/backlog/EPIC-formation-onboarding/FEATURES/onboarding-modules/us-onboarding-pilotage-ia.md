...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **IA & agents (pilotage)** ([E34](../../../EPIC-pilotage-ia/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
