...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Workflows & Automatisation** ([E29](../../../EPIC-workflows/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
