...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Workflows & Automatisation** ([E29](pathname:///pivot-docs/backlog/EPIC-workflows/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
