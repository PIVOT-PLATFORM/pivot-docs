...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Budget & suivi financier** ([E26](pathname:///pivot-docs/backlog/EPIC-budget/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
