...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Budget & suivi financier** ([E26](../../../EPIC-budget/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
