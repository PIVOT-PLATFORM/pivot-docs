...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Licences & réversibilité (pilotage)** ([E37](pathname:///pivot-docs/backlog/EPIC-pilotage-licences/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
