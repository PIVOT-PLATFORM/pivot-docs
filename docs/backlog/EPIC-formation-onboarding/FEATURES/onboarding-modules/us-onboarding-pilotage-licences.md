...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **Licences & réversibilité (pilotage)** ([E37](../../../EPIC-pilotage-licences/README.md)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
