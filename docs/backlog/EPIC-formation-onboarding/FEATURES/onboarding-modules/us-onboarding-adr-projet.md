...
| Critère | 🤖 Dev |
|---------|--------|
| Given un premier accès au module **ADR projet** ([E24](pathname:///pivot-docs/backlog/EPIC-adr-projet/)), when je l'ouvre, then un tour guidé présente ses fonctions clés (via EN41.1) | ⬜ |
