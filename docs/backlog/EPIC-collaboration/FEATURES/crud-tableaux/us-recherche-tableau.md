...
| Given une saisie rapide dans le champ de recherche, when l'utilisateur tape plusieurs caractères successifs, then le filtrage est debouncé (pas de retri à chaque frappe individuelle) pour rester fluide | ⬜ |
