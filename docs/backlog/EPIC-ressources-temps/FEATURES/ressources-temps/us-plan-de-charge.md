...
| Critère | 🤖 Dev |
|---------|--------|
| Given des affectations, when le PMO consulte le plan de charge, then la charge est confrontée à la capacité par ressource, service et compétence | ⬜ |
| La répartition distingue projet, maintenance et activités récurrentes | ⬜ |
| Error : given une tension de charge, system la détecte et la signale visuellement | ⬜ |
| Security/Gouvernance : la vue de charge respecte les périmètres de visibilité par rôle | ⬜ |
