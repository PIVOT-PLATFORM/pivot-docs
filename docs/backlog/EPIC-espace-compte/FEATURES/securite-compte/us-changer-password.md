...
- Implémenté : `pivot-core` PR [#128](https://github.com/PIVOT-PLATFORM/pivot-core/pull/128) (Gate 2 self-évalué : 96/100 — détail dans la PR) · `pivot-ui` PR [#70](https://github.com/PIVOT-PLATFORM/pivot-ui/pull/70) (Gate 2 self-évalué : 100/100 — détail dans la PR).
