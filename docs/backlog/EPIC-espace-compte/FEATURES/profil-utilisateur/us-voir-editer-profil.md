...
- Implémenté : `pivot-core` PR [#129](https://github.com/PIVOT-PLATFORM/pivot-core/pull/129) **mergée** (Gate 2 self-évalué : 92/100) · `pivot-ui` PR [#71](https://github.com/PIVOT-PLATFORM/pivot-ui/pull/71) **mergée** (Gate 2 self-évalué : 92/100 — détail dans la PR).
