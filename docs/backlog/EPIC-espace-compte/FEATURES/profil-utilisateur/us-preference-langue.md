...
- **Dépendance de branche** : les deux PR sont empilées sur les branches (non mergées) de US02.1.1 (PR#129/#71) — elles se rebaseront automatiquement une fois US02.1.1 mergée.
