...
| L'agent produit un plan à rebours (workback) à partir d'une date cible | ⬜ |
| Error : given une action hors de son périmètre autorisé, system bloque l'agent et journalise le refus | ⬜ |
| Security/Gouvernance : chaque action de l'agent est journalisée et soumise aux garde-fous de périmètre (traçabilité) | ⬜ |
