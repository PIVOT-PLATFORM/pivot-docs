...
| Les éléments contractuels sont consolidés au niveau portefeuille | ⬜ |
| Error : given une échéance contractuelle dépassée, system alerte | ⬜ |
| Security/Gouvernance : le cycle des marchés est historisé et tracé (traçabilité opposable) | ⬜ |
