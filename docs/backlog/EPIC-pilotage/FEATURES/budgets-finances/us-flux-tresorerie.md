...
| La répartition budgétaire pluriannuelle peut être appliquée en un clic sur les exercices | ⬜ |
| Error : given des données budgétaires incomplètes, system indique que la projection est partielle | ⬜ |
| Security/Gouvernance : les projections respectent les périmètres de visibilité par rôle | ⬜ |

---
Item Type: US · Parent: F18.11 · Module: pilotage · Phase: phase-3 · Size: L · Priority: Medium
Stage: Backlog
