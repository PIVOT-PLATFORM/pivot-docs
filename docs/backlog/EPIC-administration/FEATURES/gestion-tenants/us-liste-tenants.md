...
- Implémenté : `pivot-core` PR [#126](https://github.com/PIVOT-PLATFORM/pivot-core/pull/126) (CI verte, correctif SpotBugs `EI_EXPOSE_REP` appliqué en cours de revue) · `pivot-ui` PR [#69](https://github.com/PIVOT-PLATFORM/pivot-ui/pull/69) (Gate 2 self-évalué : 96/100 — détail dans la PR).
