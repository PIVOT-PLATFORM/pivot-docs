...
| [US06.1.1 — Admin liste utilisateurs (backend)](FEATURES/gestion-utilisateurs/us-liste-utilisateurs-backend.md) | ✅ Done |
| [US06.1.2 — Admin liste utilisateurs (frontend)](FEATURES/gestion-utilisateurs/us-liste-utilisateurs-frontend.md) | ✅ Done |
| [US06.1.3 — Admin modifie rôle d'un utilisateur](FEATURES/gestion-utilisateurs/us-modifier-role.md) | ✅ Done |
| [US06.1.4 — Admin désactive un compte utilisateur](FEATURES/gestion-utilisateurs/us-desactiver-compte.md) | ✅ Done |
| [US06.1.5 — Admin réactive un compte utilisateur](FEATURES/gestion-utilisateurs/us-reactiver-compte.md) | ✅ Done |
