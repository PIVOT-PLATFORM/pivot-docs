...
**Justification** : [ADR-004 v2](pathname:///pivot-docs/adr/ADR-004-oidc-multi-tenant) retient le pattern
...
**Dépendances** : [ADR-004 v2](pathname:///pivot-docs/adr/ADR-004-oidc-multi-tenant), EN01.12 (Infrastructure
