...
> Stub (Lot 5 · MoSCoW Must) — ACs à détailler par PO Agent lors de Gate 1 avant implémentation.
...
| Critère | 🤖 Dev |
|---------|--------|
| Toute production IA est tracée, localisée et validée ; l'IA ne fixe jamais le niveau de risque. | ⬜ |
