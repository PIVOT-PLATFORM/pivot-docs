...
> Stub (Lot 1 · MoSCoW Should) — ACs à détailler par PO Agent lors de Gate 1 avant implémentation.

**En tant que** Dev, Data
**Je veux** « Mode AMDEC (détectabilité) »
...
| Critère | 🤖 Dev |
|---------|--------|
| Les typologies concernées activent le facteur détectabilité. | ⬜ |
