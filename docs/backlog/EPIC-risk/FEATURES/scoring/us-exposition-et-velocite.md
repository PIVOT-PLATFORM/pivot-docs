...
> Stub (Lot 1 · MoSCoW Could) — ACs à détailler par PO Agent lors de Gate 1 avant implémentation.

**En tant que** Scrum, Chef de projet
**Je veux** « Exposition et vélocité »
...
| Critère | 🤖 Dev |
|---------|--------|
| Un risque proche ou à vélocité élevée remonte dans le classement. | ⬜ |
