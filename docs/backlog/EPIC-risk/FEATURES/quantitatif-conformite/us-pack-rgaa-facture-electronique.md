...
> Stub (Lot 4 · MoSCoW Could) — ACs à détailler par PO Agent lors de Gate 1 avant implémentation.
...
| Critère | 🤖 Dev |
|---------|--------|
| Un projet public reçoit d'office les risques RGAA et facturation électronique. | ⬜ |
