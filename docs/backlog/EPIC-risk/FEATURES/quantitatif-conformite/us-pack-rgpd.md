...
> Stub (Lot 4 · MoSCoW Should) — ACs à détailler par PO Agent lors de Gate 1 avant implémentation.
...
| Critère | 🤖 Dev |
|---------|--------|
| Un projet à données personnelles reçoit d'office les risques RGPD. | ⬜ |
