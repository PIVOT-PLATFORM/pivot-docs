...
**Je veux** organiser des **challenges d'innovation** dont le **dépôt d'idée** se fait via un **formulaire configurable** (module Forms), avec des **champs additionnels** propres au challenge
...
| Critère | 🤖 Dev |
|---------|--------|
| Given un challenge, when je le crée, then je lui associe un **formulaire de dépôt** (module Forms) avec champs spécifiques (contexte, contrainte, critères) | ⬜ |
...
Dépendances: EN38.1 · module Forms (cf. note) · US38.2.2
